    ...
    <div class="max-w-full mx-auto container-destination lg:max-w-screen-xl">
        ...
        <div class="max-w-xl mx-auto mb-10 text-center md:mb-6 lg:max-w-2xl">
            ...
            <h2 class="max-w-lg mb-2 text-3xl font-bold leading-none tracking-tight font-poppins text-dark dark:text-light sm:text-4xl md:mx-auto"
                ...
                </span> cerita dan panduan
                Taman Mini Indonesia Indah!"
            </h2>
            <p class="text-base font-normal font-inter text-graydark dark:text-graylight md:text-lg" role="heading"
                aria-level="2"> "Baca tips rute, spot foto, budaya, dan wahana agar kunjungan TMII lebih matang." </p>
        </div>
                    ...
                    <form class="flex items-center font-inter" @submit.prevent="searchPosts">
                        ...
                        <div class="relative w-full group">
                            ...
                            <input type="text" id="keyword" v-model="searchKeyword"
                                ...
                                placeholder="Cari artikel" @input="searchPosts">
                        </div>
                    </form>
                </div>
        ...
        <div class="grid grid-cols-1 gap-6 px-2 my-4 sm:grid-cols-2 md:gap-8 lg:grid-cols-3">
            <PostCard v-for="post in paginated" :key="post.id" :post="post" />
