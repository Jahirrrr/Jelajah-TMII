<template>
    <section id="tentang-tmii" class="relative px-6 py-16 mx-auto my-10 lg:max-w-screen-xl lg:py-20">
        <div class="assets">
        ...
        <div class="max-w-xl mx-auto mb-5 text-center lg:max-w-2xl">
            ...
            <p class="text-base font-normal font-inter text-graydark dark:text-graylight" role="heading" aria-level="2">
                Satu kawasan untuk merasakan budaya, edukasi, dan rekreasi Indonesia.
            </p>
        </div>
        ...
        <div class="flex flex-col gap-10 px-4 py-4 md:py-10 overflow-x-hidden md:px-10">
            <div class="flex flex-col justify-center gap-5 duration-500 md:flex-row lg:gap-10">
                <section
                    ...
                    <p class="leading-7 font-inter dark:text-graylight" aria-label="tentang tmii">Taman Mini Indonesia
                        Indah adalah ruang wisata budaya yang menghadirkan cerita Indonesia dalam satu taman terbuka.
                        Pengunjung dapat menjelajahi anjungan daerah, melihat bentuk rumah adat, menikmati lanskap Danau
                        Arsipel, mengunjungi museum, hingga mencoba wahana rekreasi keluarga dalam satu perjalanan yang
                        tertata.
                        <br><br>
                        Wajah baru TMII dibuat lebih hijau, inklusif, dan nyaman untuk keluarga. Situs ini merangkum
                        spot utama, tips kunjungan, dan inspirasi rute agar pengalaman menjelajah TMII terasa lebih
                        mudah, informatif, dan menyenangkan.
                    </p>
                    <a href="/destinasi"
                ...
                <section class="flex flex-1 justify-end gap-4 duration-500 md:min-w-[360px] lg:gap-8">
                    <div class="flex flex-col flex-1 gap-4 lg:gap-8">
                        ...
                        <div v-for="(tour, index) in leftColumnTours" :key="tour.id" class="flex-1"
                            ...
                            <a :href="`/destinasi/${tour.slug}`">
                                <img :src="`/assets/${tour.image.image}`" :alt="tour.image.alt || tour.name"
                                    class="object-cover w-full h-40 rounded-3xl sm:h-56 md:min-h-72" loading="lazy">
                            </a>
                        </div>
                    </div>
                    ...
                    <div v-if="rightColumnTour" class="flex-1" style="opacity: 1; transform: scale(1);">
                        <a :href="`/destinasi/${rightColumnTour.slug}`">
                            <img :src="`/assets/${rightColumnTour.image.image}`" :alt="rightColumnTour.image.alt || rightColumnTour.name"
                                class="object-cover w-full h-full min-h-80 rounded-3xl" loading="lazy">
                        </a>
                    </div>
                </section>
            </div>
